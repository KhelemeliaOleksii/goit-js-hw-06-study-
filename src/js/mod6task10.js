...
function createBoxes(amount) {
  const divCollection = [];
  let parameter= 30;
  for (let i = 0; i < amount; i+=1, parameter += 10*i) {
    divCollection.push(`<div style="width: ${parameter}px; height: ${parameter}px; background-color: ${getRandomHexColor()}"></div>`);
  }
...
//   //  const divCollection = new Array(amount).fill('0'); 
          // працює метод створення масиву, коли функція визивається сама, 
